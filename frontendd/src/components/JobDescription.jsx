  ...
  return (
    <div className='max-w-7xl mx-auto my-10'>
      ...
      <div className='my-4'>
        ...
        <h1 className='font-bold my-1'>Experience: <span className='pl-4 font-normal text-gray-400'>{singleJob?.experience || "years"}</span></h1>
        <h1 className='font-bold my-1'>Salary: <span className='pl-4 font-normal text-gray-400'>{singleJob?.salary}LPA</span></h1>
        <h1 className='font-bold my-1'>Total Application: <span className='pl-4 font-normal text-gray-400'>{singleJob?.applications?.length}</span></h1>
